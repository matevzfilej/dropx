...
export const useStore = create((set, get) => ({
  drops: [
    // 1) Mercator Center Ruše – 10% popusta
    ...
    // 2) Dom na Pečkah – 1 brezplačni Isotonic
    ...
    // 3) AMBIENT – marker in claim na tvoji lokaciji (radius=null => anywhere)
    ...
    // 4) CRYPTO – 3 RION, dostopen vsem (brez radija)
